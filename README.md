...
| Name | Type |
|------|------|
| [google_bigquery_job.big_lake_default_kms_key_name](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/bigquery_job) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_deletion_protection"></a> [deletion\_protection](#input\_deletion\_protection) | Prevent Terraform from destroying data storage resources (storage buckets, bigtable instance) in this blueprint. When this field is set in Terraform state, a terraform destroy or terraform appl  that would delete data storage resources will fail. | `bool` | `false` | no |
| <a name="input_gcs_kms_key"></a> [gcs\_kms\_key](#input\_gcs\_kms\_key) | The self link for the Cloud KMS key for the temporary GCS bucket. | `string` | `null` | no |
